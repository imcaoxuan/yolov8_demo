...
class YOLOv8:
    ...
    def preprocess(self) -> Tuple[np.ndarray, Tuple[int, int]]:
        ...
        self.img = cv2.imread(self.input_image) if isinstance(self.input_image, str) else self.input_image
    ...
    def main(self, input_image) -> np.ndarray:
        """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--img", type=str, default="horse.jpg", help="Path to input image.")
    ...
    output_image = detection.main(args.img)
